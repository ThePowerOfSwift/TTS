...
/// Запрос на перемещение автомобиля в архив
struct MoveToArchiveRequest: NetworkRequest, AccessTokenIdentifiable {
    ...
    func request(with baseURL: URL) throws -> Foundation.URLRequest {
        let url = baseURL.appendingPathComponent("/moveToArchive")
