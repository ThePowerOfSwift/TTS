...
open class ScrollViewController: UIViewController {
    ...
    public var backgroundView: UIView? {
        didSet {
            if let backgroundView = backgroundView {
                ...
                backgroundView.autoresizingMask = .flexibleDimensions
    ...
    open override func viewDidLayoutSubviews() {
        ...
        if !viewDidLayoutSubviewsHasBeenTriggered {
            ...
            KeyboardObserver.shared.addObserver(for: UIResponder.keyboardWillChangeFrameNotification, withinAnimation: { [weak self] _ in
